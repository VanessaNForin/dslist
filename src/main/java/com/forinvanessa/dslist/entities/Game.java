package com.forinvanessa.dslist.entities;
...
public class Game {
	...
	@GeneratedValue(strategy = GenerationType.IDENTITY) //Gera o valor de ID seguindo a estratégia entre ()
	private Long id; //Chave Primária - Id no banco de dados
	private String title; //Título
	
	@Column(name = "game_year") //Define como o nome vai aparecer na tabela de dados
	...
	@Column(columnDefinition = "TEXT") //Transforma String em Texto acima de 255 caracteres
